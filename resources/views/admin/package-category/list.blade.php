...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Package CATEGORY / List</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content  h-100">
        <div class="container-fluid  h-100">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <a href="{{ route('packageCategory.create') }}" class="btn btn-primary">Create</a>
                            </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table">
                                ...
                                @if (!empty($packageCategories) && count($packageCategories) > 0)
                                @foreach ($packageCategories as $packageCategory)
                                <tr>
                                    <td>{{ $packageCategory->id }}</td>
                                    <td>{{ $packageCategory->name }}</td>
                                    <td>{{ $packageCategory->slug }}</td>
                                    <td>{{ date('d/m/Y',strtotime($packageCategory->created_at)) }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('packageCategory.edit',$packageCategory->id) }}" class="">
                                        ...
                                        &nbsp;
                                        <a href="javascript:void(0);" class="" onclick="deletePackageCategory({{ $packageCategory->id }});">
            ...
            <div class="row">
                ...
                {{ $packageCategories->links('pagination::bootstrap-4') }}
                @endif
            </div>
...
function deletePackageCategory(id){
    if (confirm("Are you sure you want to delete?")) {
        $.ajax({
            url: '{{ url("admin/package-category/delete") }}/'+id,
            type: 'POST',
            dataType: 'json',
            data: {},
