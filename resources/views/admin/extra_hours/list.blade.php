...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Extra Hour / List</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content  h-100">
        <div class="container-fluid  h-100">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <a href="{{ route('hours.create') }}" class="btn btn-primary">Create</a>
                            </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table">
                                <tr>
                                    ...
                                    <th width="150">Packages</th>
                                    <th width="120">Created</th>
                                    <th width="100">Status</th>
                                    <th width="100">Action</th>
                                </tr>
                                @if (!empty($extraHours) && count($extraHours) > 0)
                                    @foreach ($extraHours as $hours)
                                        <tr>
                                            ...
                                            <td>{{ $hours->price }}</td>
                                            <td>
                                                @if($hours->packages->count() > 0)
                                                    {{ $hours->packages->pluck('name')->implode(', ') }}
                                                @else
                                                    <span class="text-muted">No Packages</span>
                                                @endif
                                            </td>
                                            <td>{{ date('d/m/Y', strtotime($hours->created_at)) }}</td>
                                            <td>
                                                @if($hours->status == 1)
                                            ...
                                            <td>
                                                <a href="{{ route('hours.edit',$hours->id) }}">
                                                ...
                                                &nbsp;
                                                <a href="javascript:void(0);" onclick="deleteHours({{ $hours->id }});">
            ...
            <div class="row">
                @if(!empty($extraHours))
                {{ $extraHours->links('pagination::bootstrap-4') }}
                @endif
            </div>
