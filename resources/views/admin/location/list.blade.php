...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Locations / List</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('location.edit',$location->id) }}" class="">
                                        ...
                                        &nbsp;
                                        <a href="javascript:void(0);" class="" onclick="deleteLocation({{ $location->id }});">
