                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <a href="{{ route('branding.create') }}" class="btn btn-primary">Create</a>
                            </div>
                                ...
                                @if (!empty($brands) && count($brands) > 0)
                                    @foreach ($brands as $brand)
                                        <tr>
                                            ...
                                            <td>{{ $brand->price }}</td>
                                            <td>
                                                @if($brand->packages->count() > 0)
                                                    {{ $brand->packages->pluck('name')->implode(', ') }}
                                                @else
                                            ...
                                            <td>
                                                <a href="{{ route('branding.edit',$brand->id) }}">
                                                ...
                                                &nbsp;
                                                <a href="javascript:void(0);" onclick="deleteBranding({{ $brand->id }});">
...
function deleteBranding(id){
    if (confirm("Are you sure you want to delete?")) {
        $.ajax({
            url: '{{ url("admin/branding/delete") }}/'+id,
            type: 'POST',
            dataType: 'json',
            data: {},
