...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Companies / Edit</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content h-100">
        <div class="container-fluid h-100">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="" method="post" name="editCompanyForm" id="editCompanyForm">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('companyList') }}" class="btn btn-primary">Back</a>
                            </div>
                            <div class="card-body">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly name="slug" id="slug" value="{{ $company->slug }}" class="form-control">
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="0" {{ ($company->status == 0) ? 'selected' : '' }}>Block</option>
                                    </select>
                                </div>
...
<script type="text/javascript">
    ...
    $.ajax({
        url: "{{ route('company.remove.image', $company->id) }}",
        type: 'POST',
