...
@section('content')
    ...
    <section class="content h-100">
        <div class="container-fluid h-100">
            <div class="row">
                <div class="col-md-12">
                    <form action="" method="post" name="brandingEdit" id="brandingEdit">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price" id="price" value="{{ $brand->price }}" class="form-control">
...
@section('extraJs')
    ...
    <script type="text/javascript">
        ...
        $("#brandingEdit").submit(function(event){
            event.preventDefault();
            $("button[type='submit']").prop('disabled', true);

            $.ajax({
                url: '{{ route("branding.update", $brand->id) }}',
                type: 'POST', // Change to PUT in route if needed
                dataType: 'json',
                data: $("#brandingEdit").serialize(),
