                                ...
                                <form action="" method="get">
                                    <div class="input-group mb-0 mt-0" style="width: 700px;">
                                        ...
                                        <select name="companies" class="form-control">
                                            <option value="">All Working Companies</option>
                                            @foreach($companies as $company)
                                                <option value="{{ $company->id }}" {{ request()->get('companies') == $company->id ? 'selected' : '' }}>
                                                    {{ $company->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <a href="{{ route('companyList') }}" class="btn btn-secondary ml-2">Reset</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="card-body table-responsive p-0">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $company->slug }}</td>
                                    <td>
                                        @if(!empty($company->image) && file_exists(public_path('uploads/companies/thumb/large/' . $company->image)))
                                            <img src="{{ asset('uploads/companies/thumb/large/'.$company->image) }}" alt="image" width="50">
                                        @else
                                    ...
                                    <td>
                                        ...
                                        &nbsp;
                                        <a href="javascript:void(0);" class="" onclick="deleteCompany({{ $company->id }});">
