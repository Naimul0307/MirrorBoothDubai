...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Advance Setup / Create</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content  h-100"">
        <div class="container-fluid  h-100"">
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <form action="" method="post" name="createAddon" id="createAddon">
                        <div class="card">
...
<script type="text/javascript">
    ...
    $("#createAddon").submit(function(event){
        event.preventDefault();
        $("button[type='submit']").prop('disabled',true);

        $.ajax({
            url: '{{ route("advanceSetup.store") }}',
            type: 'POST',
            dataType: 'json',
            data: $("#createAddon").serializeArray(),
