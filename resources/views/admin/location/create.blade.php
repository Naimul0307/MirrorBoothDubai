...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Location / Create</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content  h-100"">
        <div class="container-fluid  h-100"">
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <form action="" method="post" name="createLocation" id="createLocation">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="error surcharge-error"></p>
                                </div>
...
<script type="text/javascript">
    ...
    $("#createLocation").submit(function(event){
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: $("#createLocation").serializeArray(),
            success: function(response){
                ...
                if(response.status == 200) {
                    ...
                    if(response.errors.surcharge) {
                        $('.surcharge-error').html(response.errors.surcharge[0]);
                    } else {
