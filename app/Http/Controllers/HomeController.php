...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $googleData = $this->googleReviews->getReviews();
        ...
        return view('home', [
            ...
            'businessName'    => $googleData['businessName'] ?? 'Mirror Booth Dubai',
    ...
    public function searchServices(Request $request)
    {
        ...
        return view('services-search', [
            ...
            'keyword'         => $keyword,
            'companies'       => $companies,
            'meta_title'      => $keyword ? 'Search Results for "' . $keyword . '" | MIRROR BOOTH DUBAI' : 'All Services | MIRROR BOOTH DUBAI',
            'meta_description'=> $keyword ? 'Browse photo booth and event services matching: ' . $keyword : 'Browse all photo booth and event services in Dubai.',
