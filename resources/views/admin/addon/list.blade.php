                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <a href="{{ route('addon.create') }}" class="btn btn-primary">Create</a>
                            </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('addon.edit',$addon->id) }}" class="">
                                        ...
                                        &nbsp;
                                        <a href="javascript:void(0);" class="" onclick="deleteAddon({{ $addon->id }});">
...
function deleteAddon(id){
    if (confirm("Are you sure you want to delete?")) {
        $.ajax({
            url: '{{ url("admin/addons/delete") }}/'+id,
            type: 'POST',
            dataType: 'json',
            data: {},
