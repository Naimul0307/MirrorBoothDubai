                    ...
                    <div class="card border-0 text-center">
                        ...
                        <div class="card-body p-3">
                            <h4 class="card-title mt-2">
                                <a href="{{ route('service.detail', ['slug' => $service->slug]) }}">{{ $service->name }}</a>
                            </h4>
                            <div class="content pt-2">
                                <p class="card-text">{{ $service->short_desc }}</p>
                            </div>
                            <a href="{{ route('service.detail', ['slug' => $service->slug]) }}" class="btn btn-primary mt-4">
                                See In Action <i class="fa-solid fa-angle-right"></i>
                            </a>
                        </div>
                    </div>
                </div>
...
<section class="section-3 py-5">
    <div class="container py-2 text-center">
        ...
        @if($keyword)
            <p>No service found matching "<strong>{{ $keyword }}</strong>". Please try another search.</p>
        @else
...
@include('common.review', ['reviews' => $reviews])
